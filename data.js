var data = {
    ...
    },
    {
      "events": [
        ...
        },
        {
          ...
          "fees": 50,
          "rounds": [
            "The event is based on modelling an all terrain vehicle according to the rules of an international competition SAE BAJA. Participant teams have to make model of roll cage with provided material within the given time (1 hour).  Judging criteria will be based on the strength of it and that will be decided by different tests like, impact test, load test, drop test. And another criterion will be how team will use the material efficiently."
          ],
          "managers": [
            {
              "name": "Krupali Manvar",
          ...
          "tagline": "Think it, Build it, Test it"
        }
      ],
  ...
  "cultural": [
    ...
    {
      "name": "Viewfinder 2018",
      "participants": 1,
      "fees": 20,
      "notes": "Topics: 1. LeadingLines, 2. Because of Her, 3. Silhoutte, 4. Our World in Motion, 5. Monochrome",
      "prizes": [
        500,
        250
      ],
