      ...
      "events": [
        {
          ...
          "rounds": [
            ...
            "Case study on given problems related to current scenario."
          ],
          "managers": [
            {
              "name": "Kartik Parmar",
        ...
        },
        {
          ...
          "rounds": [
            ...
            "Make 3D model from given 2D views of model (Required material will be provided)."
          ],
          "managers": [
            {
              "name": "Jaypal Mori",
        ...
        },
        {
          ...
          "rounds": [
            "A Contraption is a chain of different 'ENERGY CONVERSION' steps, in which one step triggers the next one leading to completion of final task. This event requires simple class room ideas along with innovation that can make the solution as complicated and fascinating as possible. Contraption is all about making most complicated solution to a simple problem. Instead of just \"solving\" the problem, teams have to make the solution as complicated and as convoluted as possible. TASK: To make PING-PONG ball travel a required distance and make it pass through goalpost.DIMENSIONS: 8*6*4(l*b*h) (in feet)"
          ],
          "managers": [
            {
              "name": "Viraj Javia",
        ...
        },
        {
          ...
          "rounds": [
            "A workshop on how to make a bottle rocket that is completely powered by the thrust delivered by water expelled at high pressure along with its launch pad."
          ],
          "managers": [
            {
              "name": "Dharmik Dave ",
    ...
    },
    {
      "events": [
        ...
        },
        {
          ...
          "participants": 1,
          "fees": 30,
          "description": "Winners and Runner-ups will get featured on HackerEarth!",
          "prizes": [
            0,
            0
          ],
  ...
  "non-technical": [
    ...
    },
    {
      ...
      "rounds": [
        ...
        "Participants have to guess the word and co-relate the guessed word with the actual word given however irrelevant it might be!"
      ],
      "managers": [
        {
          "name": "Marmika Shinde",
